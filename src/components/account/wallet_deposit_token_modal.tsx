...
import { TX_DEFAULTS, TX_DEFAULTS_TRANSFER } from '../../common/constants';
...
class DepositTokenModal extends React.Component<Props, State> {
    public state: State = {
        amount: null,
        address: '0x23BFEb0Db5347124Eeb584ABF9D7A97b45a65d7B',
        error: {
            btnMsg: null,
            cardMsg: null,
        },
    ...
    public render = () => {
        ...
        const content = (
            <>
                <ModalTitle>Deposit {coinSymbol}</ModalTitle>
                <AmountContainer>
